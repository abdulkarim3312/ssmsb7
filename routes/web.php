...
Route::get('/category/manage', [CategoryController::class, 'manage'])->name('category.name');
...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'),'verified'])->group(function () {
    ...
    Route::get('/admin/manage-enroll/{id}', [AdminEnrollController::class, 'update'])->name('course.update-enroll-status');
});
